...
# Calling this here before building the spirals means
# "This object will exist throughout the timeline until I change it"
...
# Building the spacial instructions
...
# Building the temperal instructions
time_offsets = np.random.rand(NUM_POINTS)

# move the beads along the scafolding
for i in range(400):
    time = i * 0.01
...
# Rotate everything under "dna/structure" around an axis over time
for i in range(400):
    time = i * 0.01
    rr.set_time("stable_time", duration=time)
    rr.log(
...
"""
This rerun script does not operate live. You can see that when you run it in
the terminal and it returns. This script is a set of instructions about how to 
build the visual, both in space and over time.
"""